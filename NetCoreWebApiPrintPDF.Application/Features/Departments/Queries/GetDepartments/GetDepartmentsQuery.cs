namespace NetCoreWebApiPrintPDF.Application.Features.Departments.Queries.GetDepartments
{
    ...
    public class GetAllDepartmentsQueryHandler : IRequestHandler<GetDepartmentsQuery, byte[]>
    {
        ...
        /// </returns>
        public GetAllDepartmentsQueryHandler(IDepartmentRepositoryAsync repository, IModelHelper modelHelper, IMapper mapper, IServiceProvider serviceProvider, IHtmlToPdfService htmlToPdfService, RazorViewToStringRenderer razorViewToStringRenderer)
        {
